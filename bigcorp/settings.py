...
CSRF_TRUSTED_ORIGINS = ["https://3432-193-105-131-7.ngrok-free.app"]
...
#Static files
STATIC_URL = '/chessboard/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'chessboard/static')
...
EMAIL_FROM_ADDRESS = 'maximklimenkooo@gmail.com'  # mandatory
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'maximklimenkooo@gmail.com'
